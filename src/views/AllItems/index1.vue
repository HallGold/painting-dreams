        ...
        <div class="drawer-content-left">
          ...
          >
            ...
            <el-form-item label="项目经理" prop="xmjl">
              ...
              >
                <el-option
                  v-for="cop in managerList"
                  :key="`${cop.staffId}-${cop.staffType}`"
                  :label="cop.staffName"
            ...
            <el-form-item label="商务负责人" prop="swfzr">
              ...
              >
                <el-option
                  v-for="cop in businessAffairsList"
                  :key="cop.staffId"
                  :label="cop.staffName"
                  :value="cop.staffId"
                />
            ...
            <template #default="scope">
              <div v-if="!scope.row.referenceFileUrl" class="upload-content">
                ...
                <input
                  class="file-input"
                  type="file"
                  @change="uploadRyCkt($event, scope.$index)"
                />
              </div>
              <div v-else class="invoice-file">
